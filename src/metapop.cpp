...
[[cpp11::register]]
SEXP dust_cpu_metapop_alloc(cpp11::list r_pars, bool pars_multi, cpp11::sexp r_time,
...
[[cpp11::register]]
SEXP dust_cpu_metapop_update_state(SEXP ptr, SEXP r_pars, SEXP r_state,
...
[[cpp11::register]]
SEXP dust_cpu_metapop_filter(SEXP ptr, SEXP time_end,
...
cpp11::sexp dust_metapop_capabilities() {
  return dust::r::dust_capabilities<metapop>();
}

cpp11::sexp dust_metapop_gpu_info() {
  return dust::gpu::r::gpu_info();
}
using model_cpu = dust::dust_cpu<metapop>;

SEXP dust_cpu_metapop_alloc(cpp11::list r_pars, bool pars_multi, cpp11::sexp r_time,
                             cpp11::sexp r_n_particles, int n_threads,
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp gpu_config, cpp11::sexp ode_control) {
  return dust::r::dust_cpu_alloc<metapop>(r_pars, pars_multi, r_time, r_n_particles,
...
SEXP dust_cpu_metapop_simulate(SEXP ptr, cpp11::sexp r_time_end) {
