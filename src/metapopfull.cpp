...
[[cpp11::register]]
SEXP dust_cpu_metapopfull_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
...
[[cpp11::register]]
SEXP dust_cpu_metapopfull_filter(SEXP ptr, SEXP step_end,
...
cpp11::sexp dust_info<metapopfull>(const dust::pars_type<metapopfull>& pars) {
  const metapopfull::internal_type internal = pars.internal;
...
SEXP dust_cpu_metapopfull_alloc(cpp11::list r_pars, bool pars_multi, size_t step,
                             ...
                             cpp11::sexp r_seed, bool deterministic,
                             cpp11::sexp gpu_config) {
  return dust::r::dust_cpu_alloc<metapopfull>(r_pars, pars_multi, step, r_n_particles,
